...
copyTable() {
    ...
    querySource "\copy ${table} to program 'gzip -v6> ${filename}' delimiter ',' csv header;"
...
SOURCE_DB_NAME="${SOURCE_DB_NAME:-mirror_node}"
SOURCE_DB_PASSWORD="${SOURCE_DB_PASSWORD:-mirror_node_pass}"
SOURCE_DB_PORT="${SOURCE_DB_PORT:-5432}"
SOURCE_DB_SCHEMA="${SOURCE_DB_SCHEMA:-public}"
SOURCE_DB_USER="${SOURCE_DB_USER:-mirror_node}"

TARGET_DB_HOST="${TARGET_DB_HOST:-127.0.0.1}"
TARGET_DB_NAME="${TARGET_DB_NAME:-mirror_node}"
TARGET_DB_PASSWORD="${TARGET_DB_PASSWORD:-mirror_node_pass}"
TARGET_DB_PORT="${TARGET_DB_PORT:-5432}"
TARGET_DB_SCHEMA="${TARGET_DB_SCHEMA:-public}"
TARGET_DB_USER="${TARGET_DB_USER:-mirror_node}"
